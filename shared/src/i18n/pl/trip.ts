...
const trip: TranslationStrings = {
  ...
  'trips.public.label': 'Publiczna podróż',
  'trips.public.title': 'Publiczna podróż',
  'trips.public.enabled': 'Każdy może odkryć i zobaczyć tę podróż. Może poprosić o dołączenie.',
  'trips.public.disabled': 'Tylko zaproszeni członkowie widzą tę podróż.',
  'trips.public.makePublic': 'Upublicznij',
  'trips.public.makePrivate': 'Ustaw jako prywatną',
  'trips.joinRequests.request': 'Poproś o dołączenie',
  'trips.joinRequests.pending': 'Oczekuje',
  'trips.joinRequests.accepted': 'Zaakceptowano',
  'trips.joinRequests.sent': 'Prośba wysłana',
  'trips.joinRequests.cancelled': 'Prośba anulowana',
  'trips.joinRequests.accept': 'Akceptuj',
  'trips.joinRequests.reject': 'Odrzuć',
  'trips.joinRequests.title': 'Prośby o dołączenie',
  'trip.toast.loadError': 'Nie udało się załadować podróży',
