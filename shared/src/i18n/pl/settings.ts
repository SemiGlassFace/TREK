...
const settings: TranslationStrings = {
  ...
  'settings.notifyTripJoinRequest': 'Prośby o dołączenie',
  'settings.notifyTripJoinAccepted': 'Dołączenie zaakceptowane',
  'settings.notifyTripJoinRejected': 'Dołączenie odrzucone',
