...
const notif: TranslationStrings = {
  ...
  'notif.trip_join_request.title': 'Prośba o dołączenie',
  'notif.trip_join_request.text': '{actor} chce dołączyć do {trip}',
  'notif.trip_join_accepted.title': 'Prośba zaakceptowana',
  'notif.trip_join_accepted.text': 'Twoja prośba o dołączenie do {trip} została zaakceptowana',
  'notif.trip_join_rejected.title': 'Prośba odrzucona',
  'notif.trip_join_rejected.text': 'Twoja prośba o dołączenie do {trip} została odrzucona',
  'notif.action.reject': 'Odrzuć',
