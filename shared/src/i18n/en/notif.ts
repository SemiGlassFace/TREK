...
const notif: TranslationStrings = {
  ...
  'notif.trip_join_request.title': 'Join Request',
  'notif.trip_join_request.text': '{actor} wants to join {trip}',
  'notif.trip_join_accepted.title': 'Request Accepted',
  'notif.trip_join_accepted.text': 'Your request to join {trip} was accepted',
  'notif.trip_join_rejected.title': 'Request Rejected',
  'notif.trip_join_rejected.text': 'Your request to join {trip} was rejected',
